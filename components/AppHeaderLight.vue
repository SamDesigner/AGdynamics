<template>
  <div class="fixed right-0 left-0 top-10 font-medium text-blue-2 z-10 px-4 md:px-6 xl:px-0">
    <div class="bg-grey-2 flex h-24 md:h-[88px] items-center justify-between px-6 px-md-0 w-full max-w-[1240px] rounded-xl mx-auto">
      ...
      <ul class="navbar-links flex items-start" :class="{ 'navbar-links--navopen': open }" v-click-outside="close">
        ...
        <ul class="flex flex-col lg:flex-row lg:items-center gap-4 mt-10 lg:mt-0 lg:gap-10">
          ...
          <li @click="open = !open"><nuxt-link to="/about">About Us<Icon class="ml-1" name="ic:round-keyboard-arrow-down" size="24px" color="#001D40" /></nuxt-link></li>
          <li @click="open = !open"><nuxt-link to="/services">Care Services<Icon class="ml-1" name="ic:round-keyboard-arrow-down" size="24px" color="#001D40" /></nuxt-link></li>
          <li @click="open = !open"><nuxt-link to="/projects">Training & Events <Icon class="ml-1" name="ic:round-keyboard-arrow-down" size="24px" color="#001D40" /></nuxt-link></li>
