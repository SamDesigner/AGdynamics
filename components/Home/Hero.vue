      ...
      <div class="flex flex-col md:justify-between w-full h-full">
        ...
        <div class="-mb-20 md:-mb-40 translate-y-10 md:translate-y-20 relative max-w-fit">
          ...
          <video ref="video" controls playsinline autoplay muted loop>
            <source src="/assets/ocmc-video.mp4" type="video/mp4">
            <p>Your browser does not support HTML video, here's a <a href="/assets/ocmc-video.mp4">link </a> to watch the video</p>
          </video>
        </div>
      </div>
    </div>
