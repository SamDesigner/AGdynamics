<template>
  <div v-click-outside="clickedOutside" class="bg-whiter fixed right-0 left-0 top-24 md:top-32 font-medium z-10 overflow-y-auto overflow-x-hidden">
    <div class="flex flex-col h-[60vh] md:h-auto md:min-h-[450px] items-start w-full max-w-[1240px] rounded-xl mx-auto relative overflow-x-hidden overflow-y-auto">
      <h5 class="text-xl px-7 py-6 w-full fixed bg-whiter font-medium border-b border-b-grey-8">Care Services</h5>
      <div class="flex flex-col sm:flex-row justify-between mt-20 w-full">
        <div class="flex flex-col w-[588px]">
          <h6 class="font-medium text-grey-8 px-6 leading-[26px] py-4">Strategy Consulting</h6>
          <div class="flex flex-col sm:flex-row flex-wrap gap-4">
            <div v-for="(item, index) in consulting" :key="index" class="flex p-3 gap-4 w-[286px]">
              <img class="w-12 h-12" :src="`/img/${item.img}.png`" alt="business icon">
        ...
        <div class="flex flex-col w-[588px]">
          <h6 class="font-medium text-grey-8 px-6 leading-[26px] py-4">Services</h6>
          <div class="flex flex-col sm:flex-row flex-wrap gap-4" @click="clickedOutside">
