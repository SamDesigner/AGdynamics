    ...
    <div class="px-[64px] flex flex-col gap-[25px]">
        <div class="flex items-center gap-[25px]">
            <div class="w-[704px] bg-faintYellow  rounded-tl-[83px] rounded-bl-[83px] rounded-br-[83px]">
                <div class="px-[64px] py-[64px]">         
                    <div class="w-[425px] flex flex-col gap-[20px]">
                        <h1 class="text-maroon text-[25px] font-[600] ">Export Fulfillment Services:</h1>
                        ...
                        <NuxtLink to="#" class="flex items-center text-primaryGreen text-[14px] gap-[5px] "><span class="hover:underline">Learn more</span> <span><img src="/svg/arrow-right.svg" /></span></NuxtLink>
                    </div>
                </div>
                <div class="flex justify-end">
                    <img src="/img/malefarmer.png" />
                </div>
            </div>
            ...
            <div class="w-[581px] bg-faintYellow  rounded-tl-[83px] rounded-bl-[83px] rounded-br-[83px]">
                <div class="px-[64px] py-[64px]">         
                    <div class="w-[425px] flex flex-col gap-[20px]">
                        <h1 class="text-maroon text-[25px] font-[600] ">Mineral Sector Promotion:</h1>
        ...
        <div class="flex items-center gap-[25px]">
            ...
            <div class="w-[581px] bg-faintYellow  rounded-tl-[83px] rounded-bl-[83px] rounded-br-[83px]">
                <div class="px-[64px] py-[64px]">         
                    <div class="w-[425px] flex flex-col gap-[20px]">
                        <h1 class="text-maroon text-[25px] font-[600] ">Guarantee offtake</h1>
