<template>
    <div class="max-w-[1440px] mx-auto pt-[23px] pb-[112px] grid grid-cols-1 md:grid-cols-2 lg:flex gap-[40px] lg:gap-[80px]">
        <div class="card overflow-hidden lg:w-[617px] h-[519px] bg-faintGreen h-[54opx] pt-[64px] pb-[11px] pl-[14px] pr-[11px] rounded-tl-[20px] rounded-bl-[20px] flex flex-col justify-between">
            <div class="">
        ...
        <div class="card overflow-hidden lg:w-[617px] h-[519px] bg-faintGreen h-[542px] pt-[64px] pl-[14px] pr-[11px] rounded-tr-[20px] rounded-br-[20px] flex flex-col justify-between">
            <div class="">
...
<style scoped>
    .card{
        ...
        border: 1.064px solid rgba(192, 192, 192, 0.35);
